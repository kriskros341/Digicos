...
const Aktualnosci = () => {
	...
	return (
		<div className={options.highContrast ? "Aktualnosci__component highContrast" : "Aktualnosci__component"}>
			<motion.div layout className="bg" />
			<motion.div variants={ options.pageVariants } initial="hidden" animate="visible">
				<AnimateSharedLayout>
